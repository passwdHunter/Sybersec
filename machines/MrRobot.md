...
как видно, чтобы получить доступ ко второму ключу, то мне нужно обладать привилегиями пользователя robot, а во втором файле я увидел md5 хэш пароля пользователя robot, делать подбор хеша через hashcat мне не охота, если есть удобный сайт, сразу перехожу на crackstation.net и вставляю туда хеш:
'''
Hash	Type	Result
